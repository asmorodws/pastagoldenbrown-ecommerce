...
async function main() {
  ...
  const productDefinitions = [
    ...
    { name: 'Pandan', slug: 'pasta-pandan', desc: 'Pasta perisa pandan dengan aroma khas dan pewarna hijau natural. Best seller! Halal MUI.', sizes: ['30g', '100g', '1kg'], featured: true, halal: true },
    ...
    { name: 'Stroberi', slug: 'pasta-stroberi', desc: 'Pasta perisa strawberry dengan pewarna pink/merah untuk kreasi manis. Halal MUI dan BPOM.', sizes: ['30g', '100g', '1kg'], featured: true, halal: true },
    ...
    { name: 'Teh Hijau', slug: 'pasta-green-tea', desc: 'Pasta perisa green tea (matcha) dengan pewarna hijau natural. Halal MUI dan BPOM.', sizes: ['30g', '100g', '1kg'], featured: true, halal: true },
    { name: 'Tiramisu', slug: 'pasta-tiramisu', desc: 'Pasta perisa tiramisu dengan kombinasi kopi dan cream yang sempurna. Halal MUI dan BPOM.', sizes: ['30g', '100g', '1kg'], featured: true, halal: true },
    ...
    // ==================== PRODUK HALAL - 2 Ukuran (8 produk) ====================
    ...
    { name: 'Coffee Boy', slug: 'pasta-coffee-boy', desc: 'Pasta perisa kopi premium Coffee Boy untuk berbagai kreasi cake dan bakery. Halal MUI dan BPOM.', sizes: ['100g', '1kg'], featured: true, halal: true },
    { name: 'Cokelat Flavocol', slug: 'pasta-cokelat-flavocol', desc: 'Pasta perisa cokelat premium dengan kombinasi pewarna sempurna. Halal MUI dan BPOM.', sizes: ['100g', '1kg'], featured: true, halal: true },
    ...
    { name: 'Blueberi', slug: 'pasta-blueberi', desc: 'Pasta perisa blueberi dengan pewarna untuk hasil kue yang menarik. Halal MUI dan terdaftar BPOM.', sizes: ['30g'], featured: true, halal: true },
    ...
    // ==================== PRODUK NON-HALAL - 2 Ukuran (7 produk) ====================
    ...
    { name: 'Rum Jamaica', slug: 'pasta-rum-jamaica', desc: 'Pasta perisa rum jamaica premium untuk kreasi cake eksklusif. Belum bersertifikat halal.', sizes: ['100g', '1kg'], featured: true, halal: false },
